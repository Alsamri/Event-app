...
export default function Landing() {
  return (
    <main className="min-h-screen bg-background mt-20 pt-5">
      <section className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12 py-24 px-6">
        ...
        <div className="flex-1 relative flex items-center justify-center">
          <div className="absolute -top-20 -left-6 w-full max-w-md rounded-2xl shadow-md p-6 bg-white/50 dark:bg-black/30 backdrop-blur-sm rotate-[-6deg] scale-95 z-0">
          ...
          <div className="absolute top-57 left-6 w-full max-w-md rounded-2xl shadow-md p-6 bg-white/40 dark:bg-black/20 backdrop-blur-sm rotate-[5deg] scale-95 z-0">
            <h4 className="text-sm font-semibold text-muted-foreground">
              Design Sprint
            </h4>
          ...
          <div className="relative z-10 w-full max-w-md rounded-2xl shadow-lg backdrop-blur-md bg-white/70 dark:bg-black/40 p-8">
