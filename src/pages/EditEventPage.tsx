...
export default function EditEventPage() {
  ...
  useEffect(() => {
    async function loadEvent() {
      ...
      try {
        setFetching(true);
        const eventData = await getEvent(api, Number(id));
  ...
  try {
    ...
    if (!(form.startDate instanceof Date) || !(form.endDate instanceof Date)) {
  ...
  category: form.category,
    ...
    toast.error("Failed to update event. Please check your details.");
  } finally {
    setLoading(false);
  }
};
